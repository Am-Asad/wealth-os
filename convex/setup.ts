...
const CATEGORY_SEEDS: CategorySeed[] = [
  ...
  { name: "Utilities", bucketName: "NEEDS", transactionType: "EXPENSE", sortOrder: 4, icon: "plug" },
  { name: "Healthcare", bucketName: "NEEDS", transactionType: "EXPENSE", sortOrder: 5, icon: "cross" },
  { name: "Mutual Fund", bucketName: "INVESTMENTS", transactionType: "BOTH", sortOrder: 1, icon: "trending-up" },
  { name: "Stocks", bucketName: "INVESTMENTS", transactionType: "BOTH", sortOrder: 2, icon: "candlestick-chart" },
  { name: "Emergency Fund", bucketName: "SAVINGS", transactionType: "BOTH", sortOrder: 1, icon: "shield" },
  { name: "Goal Savings", bucketName: "SAVINGS", transactionType: "BOTH", sortOrder: 2, icon: "target" },
  { name: "Zakat", bucketName: "CHARITY", transactionType: "EXPENSE", sortOrder: 1, icon: "hand-heart" },
  { name: "Donations", bucketName: "CHARITY", transactionType: "EXPENSE", sortOrder: 2, icon: "gift" },
  { name: "Entertainment", bucketName: "FLEX", transactionType: "EXPENSE", sortOrder: 1, icon: "tv" },
  { name: "Shopping", bucketName: "FLEX", transactionType: "EXPENSE", sortOrder: 2, icon: "shopping-bag" },
];
...
const SUBCATEGORY_SEEDS: Array<{
  ...
  { bucketName: "NEEDS", categoryName: "Transport", subcategories: ["Ride Hailing", "Fuel", "Public Transport"] },
  { bucketName: "NEEDS", categoryName: "Housing", subcategories: ["Rent", "Maintenance"] },
  { bucketName: "NEEDS", categoryName: "Utilities", subcategories: ["Electricity", "Internet", "Mobile"] },
  ...
  { bucketName: "CHARITY", categoryName: "Donations", subcategories: ["Family Support", "Community Causes"] },
